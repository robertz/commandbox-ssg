...
<cfcomponent output="false">
	...
	<cffunction name="init" hint="create an instance of this object" access="public" returntype="any" output="false">
		...
		constructor = _resolveMethodByParams(
			"Constructor",
			_getClass().getConstructors(),
			arguments
		);
	...
	<cffunction
		...
		returntype="any"
		output    ="false"
		hint      ="wires the coldfusion invocation to the Java Object"
	>
	...
	<cffunction
		name      ="_setStaticFields"
		hint      ="loops around all the fields and sets the static one to this scope"
		access    ="private"
		returntype="void"
		output    ="false"
	>
	...
	<cffunction
		name      ="_buildArgumentArray"
		hint      ="builds an argument array out of the arguments"
		access    ="private"
		returntype="array"
		output    ="false"
	>
	...
	<cffunction
		name      ="_findMethod"
		hint      ="finds the method that closest matches the signature"
		access    ="public"
		returntype="any"
		output    ="false"
	>
		...
		throwException(
			"JavaProxy.MethodNotFoundException",
			"Could not find the designated method",
			"Could not find the method '#arguments.methodName#' in the class #_getClass().getName()#"
		);
		</cfscript>
	</cffunction>

	<cffunction
		name      ="_resolveMethodByParams"
	...
	<cffunction
		name      ="_initMethodCollection"
		hint      ="creates a method collection of all the methods that are available on the class (this may be cached externally later)"
		access    ="private"
		returntype="void"
		output    ="false"
	>
	...
	<cffunction
		name      ="_hasClassInstance"
		hint      ="if the proxy has an instance yet"
		access    ="private"
		returntype="boolean"
		output    ="false"
	>
